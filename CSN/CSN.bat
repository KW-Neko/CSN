...
set ULCon[0]=????????????????????????????????
set ULCon[1]=Royal Straight Flush‚ð¬—§‚³‚¹‚é
set ULCon[2]=BLACKJACK‚ÅŸ—˜‚·‚é
set ULCon[3]=’†‰›ƒ‰ƒCƒ“‚ÅSEVEN‚ð‘µ‚¦‚é
set ULCon[4]=Tie‚ð“I’†‚³‚¹‚é
set ULCon[5]=Straight Up‚ð“I’†‚³‚¹‚é
set ULCon[6]=10˜AŸ‚µ‚ÄCash Out‚·‚é
set ULCon[7]=Craps 2‚Ü‚½‚ÍCraps 12‚ð“I’†‚³‚¹‚é
